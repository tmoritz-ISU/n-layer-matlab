...
ExDiff = nufftn(ExSpecDiff, {kx, ky}, -[xSample, ySample]./(2*pi)) .* scaleKxKy;
EyDiff = nufftn(EySpecDiff, {kx, ky}, -[xSample, ySample]./(2*pi)) .* scaleKxKy;
...
ExSpecDiff2 = sin(kphi) .* (besselj(1, kr).*besselj(0, kc));
...
figure;
showImage(kx, ky, 1j*ExSpecDiff2, DisplayFormat=dispFormat);
title("Ey'");
