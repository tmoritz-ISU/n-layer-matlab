function [Gamma0e] = computeGamma0(kRho, k0, er, ur, thk)
%COMPUTEGAMMA0 Computes Gamma0e for the multilayer structure.
% This function computes the spectrum for the multilayer structure
% reflection coefficient for TM modes as a function of kRho.
% Specifically, it computes Gamma0e(kRho).
%
...
for ii = (length(thk) - 1):-1:1
    ...
    gammaE = (er(1, ii + 1, :, :) ./ er(1, ii, :, :)) .* (kz ./ kzPlus1);
