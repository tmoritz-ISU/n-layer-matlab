...
%CONSTRUCTFREQUENCYMULTIPLIERS Computes k_A2 and k_b2.
% Computes the matrices k_A2 and k_b2, used to solve the rectangular
% waveguide equation for multilayer structures.
%
% Inputs:
%   f - vector of frequencies to consider (default unit is GHz).
% Outputs:
%   k_A2 and k_b2 - Matrices used to compute S11. See usage below.
%
...
% circular TE01 waveguide. See example usage below, where "f" is scalar.
%
% Example Usage:
