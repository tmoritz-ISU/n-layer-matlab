classdef nLayerCircularTE < nLayerOpenEnded
    ...
    properties (Access=public)
        ...
        modes_TE(:, 1) {mustBeInteger, mustBeNonnegative};  % List of TE0n modes.
    end
    ...
    %% Class constructor
    methods
        function O = nLayerCircularTE(numModes, classProperties)
